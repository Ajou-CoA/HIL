...
function cdClick(){
    ...
    var cd_support = ['tr6td6','tr5td6','tr6td1','tr6td2', 'tr8td1',
...
function giJobsClick(){
    ...
    var support = ['tr2td1','tr2td3','tr6td1','tr7td1','tr8td1','tr6td2',
					...
					,'tr11td5','tr5td6','tr6td6','tr7td8','tr8td8'];
    var ch_td;
